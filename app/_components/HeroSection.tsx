        ...
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div variants={fadeInUp} className="w-full relative">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg font-light leading-relaxed text-cream/70 sm:text-2xl">
              Data Analyst & Engineer transforming complex data into singular, elegant solutions based in <span className="text-cream underline decoration-mutedGold/50 decoration-wavy underline-offset-4">Toronto, ON</span>.
            </p>
            ...
            <div className="mt-14 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
              ...
              <button
                ...
                className="btn-modern btn-secondary inline-flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-sm px-10 py-4 text-xs font-semibold tracking-[0.2em] backdrop-blur-md sm:w-auto uppercase shadow-xl"
              >
                Get in touch
              </button>
            </div>
